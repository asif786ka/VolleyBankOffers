...
public class VolleyBankImageView extends ImageView {
	...
	public VolleyBankImageView(Context context) {
		this(context, null);
	}

	public VolleyBankImageView(Context context, AttributeSet attrs) {
